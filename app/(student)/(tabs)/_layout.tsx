...
export default function StudentTabsLayout() {
  ...
  // A light poll keeps the badge fresh without holding a listener open on a
  // collection the user only partially matches.
  useEffect(() => {
    if (!user) return;
    let cancelled = false;
    ...
    const refresh = async () => {
      try {
        ...
        // Badge is cosmetic; failures stay silent.
      }
    };
